...
25.times do MenuPizza.create(name: 'The Original',
  ...
  small_price: 11.99, medium_price: 15.99, large_price: 18.99, :topping_ids =>["1", "200", "3", "22"])
end
...
2.times do MenuPizza.create(name: 'Peachza Primo',
  ...
  seasonal: true, active: true, :topping_ids =>["1", "200", "3", "22"]
  )
end
...
260.times do MenuPizza.create(name: 'Hipster Primo',
  ...
  seasonal: true, active: false, :topping_ids =>["1", "200", "3", "22"]
  )
end
