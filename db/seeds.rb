2.times do Topping.create(name: 'pepperoni')
end
...
2.times do Topping.create(name: 'pork loin',
...
2.times do MenuPizza.create(name: 'Hipster Primo',
  ...
  seasonal: true, active: false, :topping_ids =>['1', '2', '3']
  )
end
