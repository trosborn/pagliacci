["Arugula", "Basil", "Fresh Garlic", "Roasted Garlic", "Green Peppers",
  ...
  Item.create(name: "#{t}", active: true, seasonal: false, kind: 'Topping')
end
...
["Anchovies", "Hempler's Canadian Bacon", "Marinated Chicken",
  ...
  Item.create(name: "#{m}", active: true, seasonal: false, kind: 'Topping')
end
...
Item.create(name: 'Peachza Primo',
  ...
  seasonal: true, active: true, :topping_ids =>['1', '2', '4'], "sizes_attributes"=>{"1447877840428"=>{"name"=>"Small", "price"=>"18.99",
...
['Sweet Cream (Panna)', 'Chocolate', 'Chocolate Chip Mint','Salted Caramel', 'Lemon', 'Raspberry'].each do |g|
  Item.create(name: "#{g}", kind: 'Gelato')
end
